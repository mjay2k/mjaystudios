            ...
            <div className={`transition-opacity duration-300 min-w-[260px] ${minimized ? 'opacity-0' : 'opacity-100'}`}>
              ...
              {project.link && (
                <a
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-white transition-all hover:opacity-90"
              ...
              <div className="pb-4">
                ...
                {project.link && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-white transition-all hover:opacity-90"
                    style={{ backgroundColor: 'var(--color-brand)' }}
                    onClick={(e) => e.stopPropagation()}
                  >
                    Visit Site
