...
export const metadata = {
  title: 'Sent — Jesus Anoints Ministries',
  description:
    ...
    <main className="relative min-h-screen bg-white" style={{ color: 'var(--ja-ink)' }}>
      ...
      <header className="sticky top-0 z-40 border-b border-black/5 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-6">
          ...
          <Link
            href="#give"
            className="ja-display rounded-md px-5 py-2.5 text-[13px] font-extrabold uppercase tracking-[0.08em] text-[color:var(--ja-ink-900)] transition-transform hover:-translate-y-0.5"
